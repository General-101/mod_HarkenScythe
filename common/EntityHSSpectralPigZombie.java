...
public class EntityHSSpectralPigZombie extends EntityTameable
{
    ...
    public EntityHSSpectralPigZombie(World var1)
    {
        super(var1);
        this.texture = "/mods/mod_HarkenScythe/textures/models/mob/spectral_pigzombie.png";
