...
public class EntityHSSpectralSkeleton extends EntityTameable implements IRangedAttackMob
{
    ...
    public EntityHSSpectralSkeleton(World var1)
    {
        super(var1);
        ...
        this.texture = "/mods/mod_HarkenScythe/textures/models/mob/spectral_skeleton.png";
    ...
    public boolean interact(EntityPlayer var1)
    {
        ...
        if (this.isTamed())
        {
            ...
            if (var2 != null)
            {
                ...
                if (var2.getItem() instanceof ItemBow && var3 == null)
                {
            ...
            else if (var1.username.equalsIgnoreCase(this.getOwnerName()) && !this.worldObj.isRemote && var3 != null && !var1.isSneaking() && var3.getItem() instanceof ItemBow)
            {
    ...
    protected void dropFewItems(boolean var1, int var2)
    {
        ...
        if (var3 != null && var3.getItem() instanceof ItemBow && var3.getItemDamage() + 50 < var3.getMaxDamage())
        {
