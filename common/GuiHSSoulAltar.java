...
public class GuiHSSoulAltar extends GuiContainer
{
    ...
    public GuiHSSoulAltar(InventoryPlayer var1, TileEntityHSSoulAltar var2)
    {
        super(new ContainerHSSoulAltar(var2, var1));
        this.containerHSSoulAltar = (ContainerHSSoulAltar)this.inventorySlots;
        int var3;
    ...
    {
        this.fontRenderer.drawString("Altar of Souls", 6, 6, 4210752);
        this.fontRenderer.drawString("Captured Souls", 94, 6, 4210752);
        byte var3 = 0;

        if (BlockHSSoulAltar.soulCountTotal > 999)
        {
            var3 = -4;
        }

        this.fontRenderer.drawString("" + BlockHSSoulAltar.soulCountTotal, 150 + var3, 24, 16777215);
    ...
    {
        String var4 = "/mods/mod_HarkenScythe/textures/gui/guiSoulAlter.png";
        ...
        this.mc.renderEngine.bindTexture("/mods/mod_HarkenScythe/textures/gui/bookShadow.png");
        ...
        if (this.SARL[0] != 0)
        {
            ...
            {
                this.buttonList.clear();
                this.buttonList.add(new GuiButton(6, var5 + 59, var6 + 45, 86, 19, "Imbue"));
            }
        }
    ...
    public void soulAltarRecipeCheck()
    {
        ...
        if (var1 != null)
        {
            this.SARL = RecipeHSSoulAltar.soulAltarRecipeList(var1);
            this.SAAL = RecipeHSSoulAltar.soulAltarAugmentList(var1);
        }
    }
    ...
    public void actionPerformed(GuiButton var1)
    {
        ...
        int var3 = this.SARL[1] * this.inventorySlots.getSlot(0).getStack().stackSize / 5;
        int var4 = this.SAAL[1] * this.inventorySlots.getSlot(0).getStack().stackSize / 5;
        int var5 = BlockHSSoulAltar.soulCountTotal / 5;
        boolean var6 = false;
        boolean var7 = false;
        boolean var8 = false;
        ...
        if (var3 <= var5)
        {
            switch (var1.id)
            {
                ...
                case 6:
                    ...
                    {
                        this.containerHSSoulAltar.soulDrain(var3);
                    }

                    this.containerHSSoulAltar.soulAlterItem(var1.id, var2);
            }
                ...
                switch (var1.id)
                {
                    ...
                    case 20:
                        ...
                        if (!this.inventorySlots.getSlot(0).getStack().isItemEnchanted())
                        {
                            if (!this.mc.isIntegratedServerRunning())
                            {
                                this.containerHSSoulAltar.soulDrain(var4);
                            }

                            this.containerHSSoulAltar.soulAlterAugment(var1.id, var2);
                        }
            ...
            int var14 = var1.id;
            int var15 = var3 + var4;
            int var16 = this.inventorySlots.getSlot(0).getStack().itemID;
            int var17 = this.inventorySlots.getSlot(0).getStack().getItemDamage();
            boolean var18 = false;
            boolean var19 = false;
            boolean var20 = false;
            byte var21 = 0;
    ...
    public void itemStackButtonPress(int var1, int var2, int var3)
    {
        if (!this.mc.isIntegratedServerRunning())
        {
            this.containerHSSoulAltar.soulDrain(var1);
        }

        this.containerHSSoulAltar.soulAlterItem(var2, var3);
    }
}
