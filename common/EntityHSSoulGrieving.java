...
public class EntityHSSoulGrieving extends EntityHSSoul
{
    ...
    public EntityHSSoulGrieving(World var1)
    {
        super(var1);
        this.soulAge = 0;
        this.texture = "/mod_HarkenScythe/HarkenScytheTex/soul/soulgrieving.png";
    ...
    public EntityHSSoulGrieving(World var1, double var2, double var4, double var6, int var8, EntityLiving var9)
    {
        this(var1);
    ...
    {
        return this.texture = "/mods/mod_HarkenScythe/textures/models/soul/soulgrieving.png";
    }
