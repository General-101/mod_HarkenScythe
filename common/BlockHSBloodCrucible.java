...
public class BlockHSBloodCrucible extends Block
{
    ...
    public BlockHSBloodCrucible(int var1, int var2)
    {
    ...
    public void randomDisplayTick(World var1, int var2, int var3, int var4, Random var5)
    {
        ...
        {
            var1.spawnParticle("reddust", (double)((float)var2 + 0.5F), (double)((float)var3 + 0.9F), (double)((float)var4 + 0.5F), 0.8D, 0.0D, 0.0D);
        }
    }
    ...
    {
        int var7 = var1.getBlockMetadata(var2, var3, var4) * 10;
        ...
        if (var7 != 0)
        {
            ...
            EntityHSSlimeBlood var9 = new EntityHSSlimeBlood(var1);
    ...
    {
        return mod_HarkenScythe.HSCrucibleBlood.itemID;
    }
    ...
    public boolean onBlockActivated(World var1, int var2, int var3, int var4, EntityPlayer var5, int var6, float var7, float var8, float var9)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                if (var10.itemID == mod_HarkenScythe.HSBloodkeeper.itemID && var12 >= 10)
                {
                    if (var11 < 10)
                    {
                        if (!var5.capabilities.isCreativeMode)
                        {
                            var10.setItemDamage(var10.getItemDamage() + 10);
                ...
                else if (var10.itemID == mod_HarkenScythe.HSBloodVessel.itemID && var12 >= 10)
                {
                    if (var11 < 10)
                    {
                        if (!var5.capabilities.isCreativeMode)
