...
public class EntityHSSlimeBlood extends EntityHSSlime
{
    ...
    public EntityHSSlimeBlood(World var1)
    {
        super(var1);
        this.texture = "/mods/mod_HarkenScythe/textures/models/mob/slimeblood.png";
    ...
    public void onUpdate()
    {
        ...
        if (this.onGround && !var1)
        {
            ...
            for (int var3 = 0; var3 < var2 * 8; ++var3)
            {
                ...
                this.worldObj.spawnParticle("reddust", this.posX + (double)var6, this.boundingBox.minY, this.posZ + (double)var7, 0.8D, 0.0D, 0.0D);
            }
    ...
    protected EntityHSSlimeBlood createInstance()
    {
        return new EntityHSSlimeBlood(this.worldObj);
    }
    ...
    public void setDead()
    {
        ...
        if (!this.worldObj.isRemote && var1 > 1)
        {
            ...
            for (int var3 = 0; var3 < var2; ++var3)
            {
                ...
                EntityHSSlimeBlood var6 = this.createInstance();
    ...
    public boolean interact(EntityPlayer var1)
    {
        ...
        else if ((var2.itemID != mod_HarkenScythe.HSBloodkeeper.itemID || var2.getItemDamage() == 0) && var2.itemID != mod_HarkenScythe.HSEssenceKeeper.itemID && (var2.itemID != mod_HarkenScythe.HSBloodVessel.itemID || var2.getItemDamage() == 0) && var2.itemID != mod_HarkenScythe.HSEssenceVessel.itemID)
        {
            return super.interact(var1);
        }
        else
        {
            ItemHSKeeper.bloodkeeperFillCheck(var1, this.resourceWorth);
