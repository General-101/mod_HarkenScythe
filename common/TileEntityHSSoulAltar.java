...
public class TileEntityHSSoulAltar extends TileEntityEnchantmentTable implements IInventory
{
    Side side = FMLCommonHandler.instance().getEffectiveSide();
    private boolean ItemSoulAltered = false;
    private boolean BlockSoulAltered = false;
    private boolean AugmentSoulAltered = false;
    ...
    public boolean soulAlterItem(int var1, int var2)
    {
        if (var1 == 6)
        {
            this.BlockSoulAltered = true;
        }

        if (var1 != 6)
        {
            this.ItemSoulAltered = true;
        }

        return true;
    }

    public boolean soulAltarDrain(int var1)
    {
        ...
        BlockHSSoulAltar.soulDrain(var1, var2, var3, var4, this.worldObj);
        return true;
    }

    public boolean soulAlterAugment(int var1, int var2)
    {
        this.AugmentSoulAltered = true;
        return true;
    }
    ...
    {
        super.updateEntity();
        this.ItemSoulAltered = RecipeHSSoulAltar.SoulAltarUsed;
        this.BlockSoulAltered = RecipeHSSoulAltar.SoulAltarUsedBlock;
        this.AugmentSoulAltered = RecipeHSSoulAltar.SoulAltarUsedAugment;
        byte var1;
        boolean var2;
        boolean var3;
        boolean var4;
        ...
        if (this.ItemSoulAltered && this.inventory[0] != null)
        {
            this.inventory[0] = new ItemStack(RecipeHSSoulAltar.soulAltarItemStackBuilder(), RecipeHSSoulAltar.SoulAltarUsedStackSize);

            if (this.side == Side.SERVER)
            {
                this.soulAltarDrain(RecipeHSSoulAltar.SoulAltarUsedCost);
            }
            ...
            if (this.side == Side.SERVER)
            {
                RecipeHSSoulAltar.SoulAltarUsed = false;
            }
            ...
            this.ItemSoulAltered = false;
        }

        if (this.BlockSoulAltered && this.inventory[0] != null)
        {
            this.inventory[0] = new ItemStack(RecipeHSSoulAltar.soulAltarBlockStackBuilder(), RecipeHSSoulAltar.SoulAltarUsedStackSize);
            ...
            if (this.side == Side.SERVER)
            {
                RecipeHSSoulAltar.SoulAltarUsedBlock = false;
            }
            ...
            this.BlockSoulAltered = false;
        }

        if (this.AugmentSoulAltered && this.inventory[0] != null)
        {
            this.inventory[0] = RecipeHSSoulAltar.soulAltarItemStackAugmentBuilder(this.inventory[0]);
            ...
            if (this.side == Side.SERVER)
            {
                RecipeHSSoulAltar.SoulAltarUsedAugment = false;
            }
