...
public class ContainerHSBloodAltar extends Container
{
    protected TileEntityHSBloodAltar tile_entity;
    public int[] enchantLevels = new int[1];

    public ContainerHSBloodAltar(TileEntityHSBloodAltar var1, InventoryPlayer var2)
    {
    ...
    {
        this.tile_entity.bloodAlterItem(var1, var2);
        return true;
    }

    public boolean bloodDrain(int var1)
    {
        this.tile_entity.bloodAltarDrain(var1);
        return true;
    }

    public boolean bloodAlterAugment(int var1, int var2)
    {
        this.tile_entity.bloodAlterAugment(var1, var2);
        return true;
    }
