...
public class EntityHSSpectralSpider extends EntityTameable
{
    ...
    public EntityHSSpectralSpider(World var1)
    {
        super(var1);
        this.texture = "/mods/mod_HarkenScythe/textures/models/mob/spectral_spider.png";
