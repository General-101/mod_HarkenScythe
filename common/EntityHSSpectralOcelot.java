...
public class EntityHSSpectralOcelot extends EntityTameable
{
    ...
    public EntityHSSpectralOcelot(World var1)
    {
        super(var1);
        this.texture = "/mods/mod_HarkenScythe/textures/models/mob/spectral_ozelot.png";
    ...
    public String getTexture()
    {
        ...
        {
            case 0:
                return "/mods/mod_HarkenScythe/textures/models/mob/spectral_ozelot.png";

            case 1:
                return "/mods/mod_HarkenScythe/textures/models/mob/spectral_cat_black.png";

            case 2:
                return "/mods/mod_HarkenScythe/textures/models/mob/spectral_cat_red.png";

            case 3:
                return "/mods/mod_HarkenScythe/textures/models/mob/spectral_cat_siamese.png";
