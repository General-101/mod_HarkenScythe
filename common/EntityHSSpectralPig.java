...
public class EntityHSSpectralPig extends EntityTameable
{
    ...
    public EntityHSSpectralPig(World var1)
    {
        super(var1);
        this.texture = "/mods/mod_HarkenScythe/textures/models/mob/spectral_pig.png";
        this.setSize(0.9F, 0.9F);
        this.moveSpeed = 0.3F;
        this.getNavigator().setAvoidsWater(true);
        this.tasks.addTask(1, new EntityAISwimming(this));
        this.tasks.addTask(2, this.aiSit);
        this.tasks.addTask(3, this.aiControlledByPlayer = new EntityAIControlledByPlayer(this, 0.34F));
        ...
        this.tasks.addTask(7, new EntityAITempt(this, 0.3F, Item.carrotOnAStick.itemID, false));
        this.tasks.addTask(8, new EntityAITempt(this, 0.25F, mod_HarkenScythe.HSCreepBall.itemID, false));
    ...
    public boolean interact(EntityPlayer var1)
    {
        ...
        if (this.isTamed())
        {
            if (var2 != null)
            {
                ...
                if (!this.getSaddled() && var2.itemID == Item.saddle.itemID)
                {
                ...
                if (!this.isSitting() && this.getSaddled() && !this.worldObj.isRemote && (this.riddenByEntity == null || this.riddenByEntity == var1))
                {
                    var1.mountEntity(this);
                    return true;
                }
            }
            else if (!this.isSitting() && this.getSaddled() && !this.worldObj.isRemote && (this.riddenByEntity == null || this.riddenByEntity == var1))
            {
                var1.mountEntity(this);
                return true;
            }
