...
public class EntityHSSpectralZombie extends EntityTameable
{
    ...
    public EntityHSSpectralZombie(World var1)
    {
        super(var1);
        this.texture = "/mods/mod_HarkenScythe/textures/models/mob/spectral_zombie.png";
