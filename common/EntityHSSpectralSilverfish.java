...
public class EntityHSSpectralSilverfish extends EntityTameable
{
    ...
    public EntityHSSpectralSilverfish(World var1)
    {
        super(var1);
        this.texture = "/mods/mod_HarkenScythe/textures/models/mob/spectral_silverfish.png";
