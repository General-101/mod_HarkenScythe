...
public class BlockHSBloodAltar extends BlockContainer
{
    @SideOnly(Side.CLIENT)
    private Icon bloodAltarIconTop;
    @SideOnly(Side.CLIENT)
    private Icon bloodAltarIconBottom;
    public static int bloodCountTotal;

    protected BlockHSBloodAltar(int var1)
    {
    ...
    public void registerIcons(IconRegister var1)
    {
        ...
        this.bloodAltarIconTop = var1.registerIcon("mod_HarkenScythe:" + this.getUnlocalizedName() + "_top");
        this.bloodAltarIconBottom = var1.registerIcon("mod_HarkenScythe:" + this.getUnlocalizedName() + "_bottom");
    }
    ...
    {
        return var1 == 0 ? this.bloodAltarIconBottom : (var1 == 1 ? this.bloodAltarIconTop : this.blockIcon);
    }
        ...
        for (int var6 = var2 - 2; var6 <= var2 + 2; ++var6)
        {
            for (int var7 = var4 - 2; var7 <= var4 + 2; ++var7)
            {
                ...
                if (var5.nextInt(16) == 0)
                {
                    ...
                    {
                        if (var1.getBlockId(var6, var8, var7) == mod_HarkenScythe.HSBloodCrucible.blockID)
                        {
                            ...
                            var1.spawnParticle("reddust", (double)var2 + 0.5D, (double)var3 + 2.0D, (double)var4 + 0.5D, 0.8D, 0.0D, 0.0D);
                        }
                    }
                }
            }
    ...
    {
        return new TileEntityHSBloodAltar();
    }
                ...
                while (var13 <= var4 + 2)
                {
                    ...
                    while (true)
                    {
                        if (var14 <= var3 + 1)
                        {
                            label36:
                            {
                                if (var1.getBlockId(var12, var14, var13) == mod_HarkenScythe.HSBloodCrucible.blockID)
                                {
    ...
    public static boolean bloodDrain(int var0, int var1, int var2, int var3, World var4)
    {
        int var5 = var0;
        bloodCountTotal -= var0 * 10;
            ...
            while (var7 <= var3 + 2)
            {
                ...
                while (true)
                {
                    if (var8 <= var2 + 1)
                    {
                        label39:
                        {
                            if (var4.getBlockId(var6, var8, var7) == mod_HarkenScythe.HSBloodCrucible.blockID)
                            {
