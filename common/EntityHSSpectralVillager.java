...
public class EntityHSSpectralVillager extends EntityTameable
{
    ...
    public EntityHSSpectralVillager(World var1)
    {
        super(var1);
        this.texture = "/mods/mod_HarkenScythe/textures/models/mob/spectral_villager.png";
