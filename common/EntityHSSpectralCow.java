...
public class EntityHSSpectralCow extends EntityTameable
{
    ...
    public EntityHSSpectralCow(World var1)
    {
        super(var1);
        this.texture = "/mods/mod_HarkenScythe/textures/models/mob/spectral_cow.png";
