...
public class EntityHSSoulCulled extends EntityHSSoul
{
    ...
    public EntityHSSoulCulled(World var1)
    {
        super(var1);
        this.soulAge = 0;
        this.texture = "/mod_HarkenScythe/HarkenScytheTex/soul/soulculled.png";
    ...
    public EntityHSSoulCulled(World var1, double var2, double var4, double var6, int var8, EntityLiving var9)
    {
        this(var1);
    ...
    {
        return this.texture = "/mods/mod_HarkenScythe/textures/models/soul/soulculled.png";
    }
    ...
    public boolean interact(EntityPlayer var1)
    {
        ...
        else
        {
            ...
            SpecialTierAbilities.sTALivingmetal(var1, 10);
            this.setDead();
            return true;
        }
    }
