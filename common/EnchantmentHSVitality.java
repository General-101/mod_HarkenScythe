...
public class EnchantmentHSVitality extends Enchantment
{
    public EnchantmentHSVitality(int var1, int var2)
    {
        super(var1, var2, EnumEnchantmentType.armor);
        this.setName("Vitality");
    }

    public EnchantmentHSVitality(int var1, int var2, EnumEnchantmentType var3)
    {
    ...
    public static int getTotalEnchantmentLvl(EntityPlayer var0)
    {
        ...
        for (int var2 = 0; var2 < 4; ++var2)
        {
            if (var0.inventory.armorItemInSlot(var2) != null)
            {
                ...
                var1 += EnchantmentHelper.getEnchantmentLevel(mod_HarkenScythe.HSVitalityAug.effectId, var3);
            }
        }
