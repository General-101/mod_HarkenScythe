...
public class EntityHSSpectralBlaze extends EntityTameable implements IRangedAttackMob
{
    ...
    public EntityHSSpectralBlaze(World var1)
    {
        super(var1);
        this.texture = "/mods/mod_HarkenScythe/textures/models/mob/spectral_fire.png";
