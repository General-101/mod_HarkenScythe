...
public class ModelHSSpectralSkeletonWither extends ModelHSSpectralZombie
{
    public ModelHSSpectralSkeletonWither()
    {
        this(0.0F);
    }

    public ModelHSSpectralSkeletonWither(float var1)
    {
