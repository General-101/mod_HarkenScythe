...
public class RenderHSSpectralMiner extends RenderLiving
{
    protected ModelHSSpectralMiner modelBipedMain;
    protected float field_77070_b;
    protected ModelHSSpectralMiner field_82423_g;
    protected ModelHSSpectralMiner field_82425_h;
    public static String[] bipedArmorFilenamePrefix = new String[] {"cloth", "chain", "iron", "diamond", "gold"};

    public RenderHSSpectralMiner(ModelHSSpectralMiner var1, float var2)
    {
        this(var1, var2, 1.0F);
    }

    public RenderHSSpectralMiner(ModelHSSpectralMiner var1, float var2, float var3)
    {
        super(var1, var2);
    ...
    {
        this.field_82423_g = new ModelHSSpectralMiner(1.0F);
        this.field_82425_h = new ModelHSSpectralMiner(0.5F);
    }
    ...
    protected int shouldRenderPass(EntityLiving var1, int var2, float var3)
    {
        ...
        if (var4 != null)
        {
            ...
            if (var5 instanceof ItemArmor)
            {
                ...
                ModelHSSpectralMiner var7 = var2 == 2 ? this.field_82425_h : this.field_82423_g;
