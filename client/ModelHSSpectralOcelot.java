...
public class ModelHSSpectralOcelot extends ModelBase
{
    ...
    {
        this.ocelotHead.rotateAngleX = var5 / (180F / (float)Math.PI);
        this.ocelotHead.rotateAngleY = var4 / (180F / (float)Math.PI);
        ...
        if (this.field_78163_i != 3)
        {
            ...
            if (this.field_78163_i == 2)
            {
                ...
                this.ocelotTail2.rotateAngleX = 1.7278761F + ((float)Math.PI / 10F) * MathHelper.cos(var1) * var2;
            }
            else
            {
                this.ocelotBackLeftLeg.rotateAngleX = MathHelper.cos(var1 * 0.6662F) * 1.0F * var2;
                ...
                {
                    this.ocelotTail2.rotateAngleX = 1.7278761F + ((float)Math.PI / 4F) * MathHelper.cos(var1) * var2;
                }
                else
                {
    ...
    {
        EntityHSSpectralOcelot var5 = (EntityHSSpectralOcelot)var1;
