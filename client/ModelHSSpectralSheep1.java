...
public class ModelHSSpectralSheep1 extends ModelHSSpectralQuadruped
{
    private float field_78152_i;

    public ModelHSSpectralSheep1()
    {
        super(12, 0.0F);
    ...
    public void setLivingAnimations(EntityLiving var1, float var2, float var3, float var4)
    {
        ...
        this.field_78152_i = ((EntityHSSpectralSheep)var1).func_70890_k(var4);
    }
