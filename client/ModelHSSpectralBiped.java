...
public class ModelHSSpectralBiped extends ModelBase
{
    ...
    public ModelHSSpectralBiped()
    {
        this(0.0F);
    }

    public ModelHSSpectralBiped(float var1)
    {
        this(var1, 0.0F, 64, 32);
    }

    public ModelHSSpectralBiped(float var1, float var2, int var3, int var4)
    {
        this.heldItemLeft = 0;
