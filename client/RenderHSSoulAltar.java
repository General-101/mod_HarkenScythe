...
public class RenderHSSoulAltar extends TileEntitySpecialRenderer
{
    ...
    public void renderTileEntityEnchantmentTableAt(TileEntityEnchantmentTable var1, double var2, double var4, double var6, float var8)
    {
        ...
        this.bindTextureByName("/mods/mod_HarkenScythe/textures/gui/bookShadow.png");
    ...
    {
        this.renderTileEntityEnchantmentTableAt((TileEntityHSSoulAltar)var1, var2, var4, var6, var8);
    }
}
